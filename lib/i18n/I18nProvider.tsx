...
const messages = {
  zh: {
    ...
    confirmationSent: '注册请求已提交。请检查邮箱（包括垃圾邮件），按收到的验证提示操作后再登录。',
  ...
  en: {
    ...
    confirmationSent: 'Registration request submitted. Check your inbox and spam folder, follow any confirmation instructions you receive, then sign in.',
